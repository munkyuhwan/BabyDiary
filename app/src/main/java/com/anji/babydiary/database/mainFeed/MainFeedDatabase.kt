...
@Database(entities = [MainFeed::class, Profiles::class], version = 8, exportSchema = false)
    ...
    companion object{
        ...
        fun getInstance(context: Context):MainFeedDatabase {
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(context.applicationContext, MainFeedDatabase::class.java, "baby_db")
