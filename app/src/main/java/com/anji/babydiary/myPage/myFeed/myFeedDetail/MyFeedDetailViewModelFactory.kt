...
class MyFeedDetailViewModelFactory(val idx:Long, val database:MainFeedDAO, val likeDatabase:LikesDao, val profileDatabase: ProfileDao):ViewModelProvider.Factory  {
